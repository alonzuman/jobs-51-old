...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <TopBar title={translation.privacyPolicy} backButton={true} />
      <PageContainer>
        <Typography variant='body1'>
          ...
          <br/>
          היישום מכירה בחשיבות המידע האישי של משתמשיה ובאחריות המוטלת עליה מרגע קבלת המידע האישי ממשתמשיה. מדיניות פרטיות זו (להלן, 'מדיניות הפרטיות שלנו') מפרטת את האופן בו ישתמשו היישום והחברות הקשורות לה ברחבי העולם במידע האישי של משתמשיה, הן באופן פעיל או באופן פאסיבי, במסגרת שימושך בשירות של היישום, בין אם הינך שוכר, משכיר ('ליסר') או אדם הנותן/מקבל שירות מכל סוג אחר באמצעות השירות של היישום. במדיניות זו (יחד עם תנאי השימוש בשירות היישום) מבקשת היישום לקבוע את הבסיס לעיבוד כל מידע אישי שנאסף ממך, מנציגיך, או כל מידע אותו תמסור להיישום, לרבות מהו המידע אותו רשאית היישום לאסוף באמצעות הפלטפורמה שלה, באיזה אופן ישמש המידע, אופן גילוי המידע שנמסר על ידך לצדדים שלישיים והשימוש ב-'עוגיות' או בקבצים או תגיות בפלטפורמת היישום.
          <br />
